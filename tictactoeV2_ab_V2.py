...
def minimax(board):
    ...
    _, optAction = eval(board, alpha=-math.inf, beta=math.inf)
...
def eval(board, alpha, beta):
    ...
    # If terminal board, just return the utility as score and None as opt Action
    if terminal(board):
        score = utility(board)
        return (score, None)
    ...
    for action in actions(board):
        ...
        newScore, _ = eval(boardResult, alpha=alpha, beta=beta)
